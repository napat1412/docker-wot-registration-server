...
impl ArgsParser {
    ...
    fn from_matches(matches: &ArgMatches) -> Args {
        ...
        optional!(geoip_continent_th, "geoip-continent-th");
        optional!(geoip_continent_t1, "geoip-continent-t1");
        optional!(geoip_continent_t2, "geoip-continent-t2");
            ...
            pdns: PdnsOptions {
                ...
                geoip: GeoIp {
                    ...
                    continent: Continent {
                        ...
                        TH: geoip_continent_th,
                        T1: geoip_continent_t1,
                        T2: geoip_continent_t2,
                    },
                },
            },
            email: EmailOptions {
